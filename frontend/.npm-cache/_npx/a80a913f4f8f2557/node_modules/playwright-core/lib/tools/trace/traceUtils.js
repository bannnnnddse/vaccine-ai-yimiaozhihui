...
async function loadTrace() {
  ...
  const backend = new import_traceParser.DirTraceLoaderBackend(dir);
  const loader = new import_traceLoader.TraceLoader();
  await loader.load(backend, () => void 0);
  const model = new import_traceModel.TraceModel(dir, loader.contextEntries);
